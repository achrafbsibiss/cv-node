            ...
            <div class="right-side d-inline-block m-0 p-0 align-top">
                ...
                <div class="education ml-3 mt-3">
                    ...
                    <table class="per-info">
                        <tbody>
                            <tr class="border">
                                <td>${new Date(options.stage1).getFullYear()} - ${new Date(options.stage2).getFullYear()}</td>
                                <td>
                                    ${options.education}
                                </td>
                            </tr>
                            <tr class="border">
                                <td>${new Date(options.stage_3).getFullYear()} - ${new Date(options.stage_4).getFullYear()}</td>
                                <td>
                                   ${options.clasic}
                                </td>
                            </tr>
                            <tr class="border">
                                <td>${new Date(options.stage_5).getFullYear()} - ${new Date(options.stage_6).getFullYear()}</td>
                                <td>
                                    ${options.clasi}
                                </td>
                            </tr>
                ...
                <div class="key-skills ml-3 mt-3">
                    ...
                    <ul class="pl-1">
                        ...
                        <li>${options.first_one}</li>
                        <li>${options.seconde_one}</li>
                        <li>${options.third_one}</li>
